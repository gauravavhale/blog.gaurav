...
const Projects = () => {
  return (
    <div className='mb-10 mt-15' style={{minHeight:"80vh", Width:"100vw"}}>
        ...
        <div className='flex flex-col items-center gap-4 mt-4'>
            ...
            <div className='border-2 rounded-xl p-4 mt-4 w-[80vw] md:w-[60vw] md:text-center'>
                ...
                <div className='flex flex-row gap-2 mt-3 md:content-center md:justify-center'>
                    ...
                    <span className='flex items-center gap-2 border border-white p-2 rounded-xl text-black bg-gray-100'>Tailwind</span> 
