      ...
      <div className='text-center w-full md:w-[70vw]'>
        ...
        <div>
          ...
          <h2>I was born and raised in Chhatrapati Sambhajinagar 
              ...
              Growing up, I believed that if I followed the usual path, 
              everything would fall into place.
              But somewhere along the way, life started unfolding differently than I had imagined.
          </h2>
          <h2>There was a phase when nothing seemed to align with my plans. 
              I felt stuck like I had missed the train everyone else seemed to be on. 
              It was frustrating, disheartening, and honestly, a little scary.
              But sometimes, it's when you feel completely lost that you start discovering who you truly are.
          </h2>
        </div>
        ...
        <div>
          ...
          <div>
            ...
            It felt like I was just passing the days, hoping something would change on its own.
          </div>
          <div>
        ...
        <div>
          ...
          <div>
            In my MERN stack classes, I learned step by step how the web works, 
            how frontend connects to backend, and how to build something that actually runs. 
            I still remember how excited I was when my first project worked without errors. 
            It was a small achievement, but it gave me a huge confidence boost.
          </div>
          <div>
            Over time, I built more projects — from portfolios to a fully working e-commerce app. 
            With each one, I not only improved my skills but also proved to myself that I could do this.
            Now, when I look back at where I started, I feel proud. 
            I may not have taken the usual route, but I built my foundation brick by brick 
            with patience, persistence, and a lot of Google searches.
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            ...
            whether it's my first job offer, a failed interview, a trip I loved, 
            or just a random thought on a sleepless night.
          </div>
        </div>
